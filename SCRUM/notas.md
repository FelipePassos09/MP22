...
<li>São sempre abertos em aprender coisas novas</li>
<li>Estão continuamente aprimorando-se</li>
<lI>Possem sempre entregas tangíveis</lI>
</p>
<h2>Princípio #3 → Colaboração</h2>
<p>Como dito acima, uma característica da equipe SCRUM é a colaboração. É importante que a equipe trabalhe como tal, evitando ambições, individualismo ou preconceitos, evitando ao máximo a competitividade. Uma equipe colaborativa é formada por três pilares:
<h3>Conciência</h3>
<p>Cada integrante tem conci~encia de seus colegas, sua importância para o projeto e o que cada um deles faz. Todos são importantes para o resultado e colaboram da forma como melhor podem sendo, nesse caso, não um número mas um elemento essencial. Assim como um motor onde cada engrenagem é importante, cada integrante da equipe é importante e a sua falta pode gerar graves problemas.</p>
<h3>Articulação</h3>
<p>A equipe procura sempre divir o esforço se preocupando em sempre colaborar com os demais ajudando nas suas necessidades e assumindo tarefas a fim de evitar sobrecargas. Além disso todos precisam ser unidos em prol do resultado.</p>
<h3>Apropriação</h3>
<p>Com a Articulação é vem a apropriação que é o entendimento de que todos são responsáveis e devbem colaborar com seus colegas ajudando em problemas encontrados como em um entrave durante alguma atividade ou em algum ponto do processo de desenvolvimento. É imprescindível que todos tenham tal conci~encia pois dessa maneira haverá a liberdade e intimidade para que o time se ajude mutuamente.</p>
Como pode ser visto, esses tr~es pilares promovem uma integridade da equipe, onde todos trabalham de maneira sincronizada e colaborativa, trazendo leveza e fluidez aos processos e mantendo um clima harmonioso. Também promovem o bem estar coletivo e a escalada em prol do objetivo da equipe, facilitando e, muitas vezes, gerando laços internos com os membros além de um sentimento de pertencimento, onde todos podem atuar de maneira uníssona nas tarefas a serem cumpridas.
</p>
<h2>Princípio #4 → Priorização Baseada em Valor</h2>
<p>Dentro do SCRUM, por ser embasado por um desenvolvimento de projeto em ciclos (sprints) deve-se observar as entregas de valor, ou seja, elencar as necessidades do cliente e observar quais delas iram gerar mais valor, decrescendo essa prioridade no decorrer das entregas, ou seja, entregar o que há de mais importante para o cliente primeiro e, por último, aquilo que possui menos valor. Cada ciclo terá, nesse caso, uma importância menor a ser observada dos requisitos.<br />Dentro do SCRUM a responsabilidade por isso é, principalmente, do Product Owner, ele quem ira coletar essa informação junto ao cliente e elencar o product backlog em função das necessidades identificadas, gerando assim uma lista ordenada de entregas priorizadas onde a equipe de desenvolvimento analisará a melhor maneira de efetuar essa entrega a cada sprint. E um produto isso se caracteriza por um decaimento na evolução visivel uma vez que cada entrega possui um valor menor, mas ao final do processo o produto completo terá uma maior qualidade e será entregue mais rápido e com maior aproveitamento pelo cliente desde suas etapas iniciais de desenvolvimento. Essa é a principal caracteristica do SCRUM, sua agilidade junto ao cliente pois as entregas pariciais visando importância geram maior valor diante do cliente.</p>
<h2>Princípio #5 → Time-Boxing</h2>
